/**
 * Creates questions from scripts/data/politics-questions.fr.json — ~270 French and European
 * politics questions (institutions, history, EU treaties/enlargements, difficulty 1-5), hand
 * authored for this project (not sourced from an external, independently-vetted dataset the way
 * imported-questions.fr.json is).
 *
 ...
 *
 * Run: pnpm tsx scripts/seed-politics-questions.ts [--author alex] [--dry-run]
 */
...
async function main() {
  ...
  const file = JSON.parse(
    readFileSync(new URL("./data/politics-questions.fr.json", import.meta.url), "utf-8"),
  ...
  console.log(
    JSON.stringify({
      event: "seed_politics_questions_complete",
      created,
      skipped,
