/**
 * Creates questions from scripts/data/history-questions.fr.json — 127 questions on the French
 * Revolution, the Russian Revolution, WW1, WW2, and the German economy 1900-1950, difficulty
 * 1-5, hand authored for this project (not sourced from an external, independently-vetted
 * dataset the way imported-questions.fr.json is).
 *
 ...
 *
 * Run: pnpm tsx scripts/seed-history-questions.ts [--author alex] [--dry-run]
 */
...
async function main() {
  ...
  const file = JSON.parse(
    readFileSync(new URL("./data/history-questions.fr.json", import.meta.url), "utf-8"),
  ...
  console.log(
    JSON.stringify({
      event: "seed_history_questions_complete",
      created,
      skipped,
